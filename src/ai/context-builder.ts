...
function buildBaseInstructions(metadata: SpaceMetadata): string {
...
function buildSpaceContext(metadata: SpaceMetadata): string {
...
function buildNotesSection(notes: Notes): string {
...
function buildTimelineSection(timeline: Timeline): string {
...
export function estimateContextTokens(prompt: string): number {
